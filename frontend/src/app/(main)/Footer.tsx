...
const Footer = () => {
  return (
    <div className="w-screen bg-[#18181B]">
      ...
      <div className="flex w-full px-[88px] py-[76px] gap-[104px] flex-col">
        <div className="flex gap-[220px] items-start">
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col">
              <div className="flex">
                <p className="text-[20px] font-[600] text-white">Nom</p>
                <p className="text-[20px] font-[600] text-[#EF4444]">Nom</p>
              </div>
          ...
          <div className="flex gap-[112px]">
            <div className="flex flex-col gap-4">
              ...
              <p className=" text-[#FAFAFA] text-[16px]">Devivery zone</p>
            </div>
        ...
        <div className="flex gap-12 py-8 border-t-[#71717A] border-t border-t-solid">
          <div className="flex gap-1">
            <p className="text-[#71717A]">Copy right 2024</p>
            <p className="text-[#71717A]">©</p>
            <p className="text-[#71717A]">Nomnom LLC</p>
          </div>
