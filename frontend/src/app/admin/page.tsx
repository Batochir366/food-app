    ...
    <div className="flex flex-col gap-10 px-5 py-[36px] size-fit bg-[#F4F4F5]">
      <div className="flex gap-2 size-fit">
        ...
        <div className="flex flex-col">
          <p className="text-[20px] font-[600] text-black">NomNom</p>
          <p className="text-[#71717A] text-[13px] font-[500]">
            Swift devivery
          </p>
        </div>
      </div>
      <TabsAdmin defaultValue="menu" className="w-screen h-fit flex gap-6">
        <TabsListAdmin className="flex gap-6 flex-col w-[165px] bg-white h-screen">
          <TabsTriggerAdmin
            className="flex w-full h-fit itmes-center justify-start gap-[10px] px-6 py-2 rounded-full"
            value="menu"
          >
            <LayoutDashboard />
            Food menu
        ...
        <div className="flex bg-[#F4F4F5]">
          <TabsContentAdmin
            className="flex size-fit flex-col gap-5"
            value="menu"
          >
            <div className="flex size-fit py-6 px-6 gap-4 rounded-[12px]  bg-white">
              <div className="flex flex-col  w-full gap-9">
                <h1 className="font-[600] text-[20px]">Dishes category</h1>
          ...
          <TabsContentAdmin value="settings">.</TabsContentAdmin>
        </div>
      </TabsAdmin>
    </div>
  );
